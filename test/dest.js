...
describe('dest stream', function() {
  ...
  it('should accept the sourcemap option as true', function(done) {
    var file = new File({
      base: inputBase,
      path: inputPath,
      contents: null,
  ...
  it('should accept the sourcemap option as a string', function(done) {
    var file = new File({
      base: inputBase,
      path: inputPath,
      contents: null,
  ...
  it('should accept the sourcemap option as an object', function(done) {
    var options = {
      sourcemaps: {
        addComment: false,
      },
  ...
  it('should successfully process files with streaming contents', function(done) {
    var file = new File({
      base: inputBase,
      path: inputPath,
      contents: from([contents]),
